...
class Profile extends DefaultLayout {
  renderContent(): JSX.Element {
    ...
    return (
      ...
      <BasePanel header="最近创建的话题" white={true} className="page-profile">
        <div className="name">
          <span>{user.nick_name}</span>
          <a href={`https://github.com/${user.github_id}`} className="github">
            {user.name}
      ...
      <BasePanel header="最近参与的话题" white={true} className="page-profile">
        <div className="name">
          <span>{user.nick_name}</span>
          <a href={`https://github.com/${user.github_id}`} className="github">第一条</a>
        </div>
        <div className="name">
          <span>{user.nick_name}</span>
          <a href={`https://github.com/${user.github_id}`} className="github">第2条</a>
        </div>
        <div className="name">
          <span>{user.nick_name}</span>
          <a href={`https://github.com/${user.github_id}`} className="github">第3条</a>
        </div>
    </BasePanel>
    </>
    );
